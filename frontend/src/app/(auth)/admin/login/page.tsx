...
import { Shield, ArrowLeft, Sun, Moon, Lock, Mail, Activity, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#080c16] relative flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Admin Console</h2>
          <p className="text-slate-500 dark:text-slate-400 text-xs">Enter your administrative credentials to log in.</p>
        </div>
