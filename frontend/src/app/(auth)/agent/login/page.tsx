...
import { UserCheck, ArrowLeft, Sun, Moon, Lock, Mail, Activity } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#080c16] relative flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-1">Agent Console</h2>
          <p className="text-slate-400 text-xs">Enter your agent credentials to log in.</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border bg-slate-950/60 text-white placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-sky-500/50 focus:border-sky-500/50 transition-colors ${
